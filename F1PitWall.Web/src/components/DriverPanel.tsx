...
export function DriverPanel({ driver, onClose, headshot }: Props) {
  if (!driver) {
    return (
  ...
  return (
    ...
    >
      ...
      <div className="driver-panel-header">
        ...
        />
        {headshot && (
          <img src={headshot} className="panel-headshot" alt={driver.abbreviation} />
        )}
        <div>
      ...
      <div className="panel-section">
        <h3 className="panel-section-title">Telemetry</h3>
      ...
      {/* ── Tyre ───────────────────────────────────────── */}
      <div className="panel-section">
        <h3 className="panel-section-title">Tyre</h3>
      ...
      {/* ── Timing ─────────────────────────────────────── */}
      <div className="panel-section">
        <h3 className="panel-section-title">Timing</h3>
